...
```
```bash
sudo firewall-cmd --add-port=8028/tcp; sudo firewall-cmd --add-port=8028/tcp  --permanent
```
```bash
sudo firewall-cmd --add-port=4043/tcp; sudo firewall-cmd --add-port=4043/tcp  --permanent
```
----
