...
## Исключить службу Windows из мониторинга Zabbix?
> например: GoogleUpdaterService138.0.7194.0

### Добавление исключений
#### Для того чтобы внести службу в список исключений, откройте шаблоны агента Zabbix по пути, указанному на скрине:
...
> Добавим в исключение службу GoogleUpdaterService138.0.7194.0 таким образом, чтобы после её обновления на другую версию, она также оставалась в исключениях:
...
#### Подождите, пока события пропадут из дашборда, а затем подключите темплейт "Windows by Zabbix agent" заново.
