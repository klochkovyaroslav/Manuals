...
#### При помощи редактора SED и вывести на экран содержимое файла some_file.txt и предварительно удалить строку содержащую подстороку: "etc", в самом файле строка не удалится, только на экране
```bash
